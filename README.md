...
└── images/
    ├── 01_ebay-listing.jpg                ← eBay listing — NUC7i5BNH barebone, £64.99
    ├── 02_board-overview.jpg              ← Board fully exposed — top-down view
    ├── 03_board-labels-ram.jpg            ← Board model label (NUC7i5BNB) + 1.2V DDR4 slots
    ├── 04_bios-se-jumper.jpg              ← BIOS_SE security jumper header location
    ├── 05_board-m2-area.jpg               ← M.2 slot and board underside
    ├── 06_bios-security-menu.jpg          ← Aptio V security override menu (jumper removed)
    ├── 07_firmware-flash-done.jpg         ← Firmware flash log — all blocks [done]
    ├── 08_f7-update-tool.jpg              ← F7 BIOS update tool — BN0093.bio detected
    ├── 09_post-flash-bios.jpg             ← Post-flash BIOS setup — BNKBL357.86A.0093, 16GB confirmed
    ├── 10_seller-msg-return-offered.jpg   ← eBay message — return offered by seller
    ├── 11_seller-msg-resolved.jpg         ← eBay message — resolution confirmed 24 Jan
    └── 12_seller-msg-closing.jpg          ← eBay message — "not an inconvenience but an opportunity"
```

**[→ View the full case study (live HTML)](https://arturskaufmanis.github.io/BIOS-recovery/nuc-bios-recovery-portfolio.html)**
...
| | |
|---|---|
| ![eBay listing](images/01_ebay-listing.jpg) | ![Board overview](images/02_board-overview.jpg) |
| *eBay listing — NUC7i5BNH barebone, £64.99* | *Board fully exposed — NUC7i5BNB* |

### Hardware Internals

| | |
|---|---|
| ![Board labels and RAM](images/03_board-labels-ram.jpg) | ![BIOS_SE jumper](images/04_bios-se-jumper.jpg) |
| *Board model label NUC7i5BNB confirmed — 1.2V DDR4 SO-DIMM slots* | *BIOS_SE 3-pin security jumper header location* |

![M.2 slot area](images/05_board-m2-area.jpg)  
*Board underside — M.2 2280 slot and front panel connector area*

### BIOS & Firmware

| | |
|---|---|
| ![BIOS security menu](images/06_bios-security-menu.jpg) | ![Firmware flash done](images/07_firmware-flash-done.jpg) |
| *Aptio V security override menu — appeared when no .bio detected on USB* | *Firmware flash log — all blocks [done], ME firmware finalising* |

| | |
|---|---|
| ![F7 update tool](images/08_f7-update-tool.jpg) | ![Post-flash BIOS](images/09_post-flash-bios.jpg) |
| *F7 BIOS Update Tool — BN0093.bio detected, confirmation prompt* | *Post-flash BIOS setup — version BNKBL357.86A.0093, 16GB RAM confirmed* |

### Seller Communication

| | |
|---|---|
| ![Seller return offer](images/10_seller-msg-return-offered.jpg) | ![Resolution confirmed](images/11_seller-msg-resolved.jpg) |
| *19 Jan — seller offered full return, challenge accepted instead* | *24 Jan — resolution confirmed, device fully operational* |

![Closing message](images/12_seller-msg-closing.jpg)  
...
- [Intel NUC7i5BNH Product Guide](https://www.intel.com/content/www/us/en/products/sku/95077/intel-nuc-kit-nuc7i5bnh/specifications.html)
